...
public class RoseAttack3_2 extends AttackType{

    private double moveBaseTimer = 0;
    private double addTimer = 0.1;
    private int period;

    public RoseAttack3_2(double speed, BulletOwner owner, Color color, boolean  moveTrigger) {
        this.attackRate = 170;
        this.attackDelay = 0;
        this.bulletParam = new BulletParameters(speed, owner, new double[10], 5, color, 150, moveTrigger);

        this.period = (int)(2 * Math.PI / addTimer) * 2;
    }
    ...
    public void Attack (Pane root, Character attackChar) {
        ...
        if (attackDelay <= 0) {
            ...
            if (period > 0) {
                ...
                Point firstPos = MathUtils.CalcRoseCurve(moveBaseTimer, 150, 3, 2);
                ...
                period = (int)(2 * Math.PI / addTimer) * 2;
