...
public class HypoAttack_5 extends AttackType{

    private double moveBaseTimer = 0;
    private double addTimer = 0.1;
    private int period;

    public HypoAttack_5(double speed, BulletOwner owner, Color color, boolean  moveTrigger) {
        this.attackRate = 170;
        this.attackDelay = 0;
    ...
    public void Attack (Pane root, Character attackChar) {
        ...
        if (attackDelay <= 0) {
            ...
            if (period > 0) {
                ...
                Point firstPos = MathUtils.CalcHypoCycloid(moveBaseTimer, 40, 5);
