...
public class RoseAttack4_3 extends AttackType{

    private double moveBaseTimer = 0;
    private double addTimer = 0.11;
    private int period;

    public RoseAttack4_3(double speed, BulletOwner owner, Color color, boolean  moveTrigger) {
        this.attackRate = 170;
        this.attackDelay = 0;
    ...
    public void Attack (Pane root, Character attackChar) {
        ...
        if (attackDelay <= 0) {
            ...
            if (period > 0) {
                ...
                Point firstPos = MathUtils.CalcRoseCurve(moveBaseTimer, 150, 4, 3);
